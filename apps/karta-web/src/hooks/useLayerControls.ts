...
export function useLayerControls() {
  ...
  const map = useMemo<Record<LayerStateKey, { value: boolean; set: (on: boolean) => void }>>(
    () => ({
      ...
      showZgObrazovanje: { value: s.showZgObrazovanje, set: s.setShowZgObrazovanje },
      showZgZdravlje: { value: s.showZgZdravlje, set: s.setShowZgZdravlje },
      showZgKretanje: { value: s.showZgKretanje, set: s.setShowZgKretanje },
      showZgSvakodnevno: { value: s.showZgSvakodnevno, set: s.setShowZgSvakodnevno },
      showZgOtpad: { value: s.showZgOtpad, set: s.setShowZgOtpad },
      showZgSigurnost: { value: s.showZgSigurnost, set: s.setShowZgSigurnost },
